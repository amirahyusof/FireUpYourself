...
export default function MainPage(){
  return (
    <div className="flex justify-center mx-auto mt-20 overflow-hidden max-w-md rounded-4xl h-[640px] bg-gradient-to-r from-yellow-400 to-indigo-500 transition-colors duration-300">
